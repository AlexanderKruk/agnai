...
- Affiliates: We may disclose Personal Information to our affiliates, meaning an entity that controls, is controlled by, or is under common control with PornAI. Our affiliates may use the Personal Information we share in a manner consistent with this Privacy Policy. 
...
You can exercise some of these rights through your PornAI account. If you are unable to exercise your rights through your account, please send your request in our [discord server ("https://discord.agnai.chat")](https://discord.agnai.chat).
...
Our Service is not directed to children who are under the age of 18. PornAI does not knowingly collect Personal Information from children under the age of 18. If you have reason to believe that a child under the age of 18 has provided Personal Information to PornAI through the Service please contact us on our [discord server ("https://discord.agnai.chat")](https://discord.agnai.chat). We will investigate any notification and if appropriate, delete the Personal Information from our systems.

## 7. Links to other websites

The Service may contain links to other websites not operated or controlled by PornAI, including social media services ("Third Party Sites"). The information that you share with Third Party Sites will be governed by the specific privacy policies and terms of service of the Third Party Sites and not by this Privacy Policy. By providing these links we do not imply that we endorse or have reviewed these sites. Please contact the Third Party Sites directly for information on their privacy practices and policies. 
...
Please contact us on our [discord server ("https://discord.chat")](https://discord.chat) if you have any questions or concerns not already addressed in this Privacy Policy.
`

const PrivacyPolicyPage: Component = () => {
  return (
    <Page>
      <PageHeader title={<>PornAI Privacy Policy</>} />
